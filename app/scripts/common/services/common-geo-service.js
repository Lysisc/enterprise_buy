...
angular.module('GSH5').factory('$geo', ['$http', '$locate', '$timeout', function ($http, $locate, $timeout) {
  ...
  var cachedPosition, TIME_OUT = 2000,
    ...
    parseGoogleGeoInfo = function (respObj) {
      ...
      try {
        ...
        var addressComponents = respObj.results[0].address_components, addressComponent,
          i, j, len, len2;
